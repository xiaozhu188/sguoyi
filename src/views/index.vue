            ...
            <a-menu :theme="theme" mode="inline" :default-selected-keys="selectedKey">
                ...
                <a-menu-item-group key="utils" title="工具函数">
                    <a-menu-item key="sgyRequest">
                        <router-link to="/sgyRequest">
                            <span class="nav-text">sgy-request <span class="chinese">网络请求</span></span>
                        </router-link>
                    </a-menu-item>
                    <a-menu-item key="Debounce">
                        <router-link to="/observer">
                            <span class="nav-text">Debounce <span class="chinese">防抖</span></span>
                        </router-link>
                    </a-menu-item>
                    <a-menu-item key="Throttle">
                        <router-link to="/observer">
                            <span class="nav-text">Throttle <span class="chinese">节流</span></span>
                        </router-link>
                    </a-menu-item>
                </a-menu-item-group>
            </a-menu>
